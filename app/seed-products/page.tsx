    ...
    <div className="container mx-auto py-10">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            This will add sample products to your database. Existing products
            with the same name will be updated.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <p>
            This will create sample products for each category in your database.
            Make sure you have created categories first.
          </p>
        </CardContent>
        <CardFooter>
