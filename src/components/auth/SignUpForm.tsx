...
// Extend Supabase types to include the custom RPC function
type CheckIfEmailExistsArgs = { email_to_check: string };
declare module "@supabase/supabase-js" {
  interface SupabaseClient {
    rpc(
      fn: "check_if_email_exists",
      args: CheckIfEmailExistsArgs
